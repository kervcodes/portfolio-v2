        ...
        <section id="projects" className="py-24 relative overflow-hidden scroll-mt-24">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="text-center mx-auto max-w-3xl mb-16">
                    <h2 className="font-serif text-4xl md:text-5xl font-bold mb-6 animate-fade-in text-foreground">
                        Things I've
                    ...
                    <p className="text-muted-foreground animate-fade-in animation-delay-200">
                        Four products built end to end — mobile, web, and infrastructure.
                        Each one shipped alone, from first commit to deployment.
                    </p>
                </div>
