...
const PROJECTS = [
    {
        ...
        milestones: [
            { label: "Extract raw transactions from PDF statements", done: true },
            { label: "Define and validate a normalized transaction schema", done: true },
            { label: "Merge multi-account, multi-month statements and reconcile against balances", done: false },
            { label: "Detect recurring expenses, duplicates, and spending categories", done: true },
            { label: "Strip PII and surface a consolidated financial dashboard", done: true },
        ],
        demoUrl: null,
        githubUrl: null,
    },
